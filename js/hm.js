;(function () {
  ...
  mt.h.J = function (a, b) {
    ...
    for (; a.parentNode != t; ) {
      for (
        var f = 0, m = 0, l = a.parentNode.childNodes.length, e = 0;
        e < l;
        e++
      ) {
    ...
    if (a)
      return (
          ...
          (d = a.getBoundingClientRect()),
        {
          ...
          left:
            d.left + (window.pageXOffset || b.scrollLeft) - (b.clientLeft || 0),
        }
      )
  }
  ;(mt.h.Z = (function () {
  ...
  mt.localStorage.set = function (a, b, d) {
    ...
    try {
      window.localStorage
        ? ((b = g.getTime() + '|' + b), window.localStorage.setItem(a, b))
        : mt.localStorage.C() &&
          ((mt.localStorage.g.expires = g.toUTCString()),
  ...
  ;(function () {
    ...
    ;(function () {
      ...
      'object' == typeof document.onfocusin
        ? (f.c(document, 'focusin', g), f.c(document, 'focusout', g))
        : (f.c(window, 'focus', g), f.c(window, 'blur', g))
    })()
    h.F = {
      ra: function () {
        return +new Date() - w
        ...
        _setCustomVar: function (a) {
          if (!(4 > a.length)) {
            ...
            if (0 < b && 6 > b && 0 < f && 4 > f) {
              e.B++
              for (
                var p = (h.b.a.cv || '*').split('!'), q = p.length;
                q < b - 1;
                q++
              )
                p.push('*')
          ...
          1 < a.length &&
            ((h.b.a.su =
              a[1].charAt && '/' === a[1].charAt(0)
                ? f.protocol + '//' + window.location.host + a[1]
                : a[1]),
            (e.W = s))
        },
        ...
        _trackRTEvent: function (a) {
          ...
          if (d.d(a, 'Object')) {
            ...
            if (900 >= l) k.call(this, a)
              ...
              for (
                var l = Math.ceil(l / 900),
                  p =
                    'block|' +
                    Math.round(Math.random() * f.N).toString(16) +
                    '|' +
                    l +
                    '|',
                  q = [],
  ...
  ;(function () {
    ...
    a.prototype = {
      ...
      sa: function () {
        ...
        var a = u
        this.z(document.referrer) && this.z(document.location.href)
          ? (a = s)
          : ((a = b.U(document.referrer)),
      ...
      setData: function (a, b, d) {
        try {
          m.set(a, b, { domain: this.I(), path: this.T(), H: d }),
            d ? e.set(a, b, d) : n.set(a, b)
        } catch (f) {}
      },
      Da: function (a) {
        try {
          m.set(a, '', { domain: this.I(), path: this.T(), H: -1 }),
            n.remove(a),
            e.remove(a)
        } catch (b) {}
      },
      ...
      Fa: function () {
        ...
        this.V
          ? ((this.K = s), (this.a.et = 0), (this.a.ep = ''), this.k(a))
          : a()
      },
      k: function (a) {
        var b = this
      ...
      fa: function () {
        ...
        a &&
          ...
          e &&
          g &&
          ((this.a.rnd = Math.round(Math.random() * k.N)),
      ...
      if (
        ...
        var e = function () {
          ...
          if ('www.baidu.com' === n[2] || 'm.baidu.com' === n[2])
            (v = d.f(a, 'qid')), (b = d.f(a, 'click_t'))
          a = v
          e.qid = a != t ? a : ''
          b != t
            ? ((e.bdDom = l ? l - b : 0),
              (e.bdRun = f - b),
              (e.bdDef = m('navigation').start - b))
            : ((e.bdDom = 0), (e.bdRun = 0), (e.bdDef = 0))
          h.b.a.et = 87
              ...
              (d = b[g]),
                l !== r
                  ? ((e = d.getAttribute('onclick')),
                    ...
                    p
                      ? ((d = d.getAttribute('id')),
                        (l.test(e) || l.test(f) || p.test(d)) && a.push(b[g]))
                      : (l.test(e) || l.test(f)) && a.push(b[g]))
                  : p !== r &&
                    ((d = d.getAttribute('id')), p.test(d) && a.push(b[g]))
            return a
          },
        }
      }
